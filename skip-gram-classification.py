...
if __name__ == '__main__':
    ...
    vocab = torch.load(f'./models/skip-gram-vocab_{str(window_size)}.pt')

    word_vectors = torch.load(f'./models/skip-gram-word-vectors_{str(window_size)}.pt')
    ...
    if choice == "yes":
        ...
        model = torch.load(f'./models/skip-gram-classification-model_{str(window_size)}.pt', map_location=device)
        loaders = {
        ...
        plt.matshow(cm)
        plt.title(f'Confusion matrix Skip Gram {str(window_size)}')
        plt.colorbar()
        plt.ylabel('True label')
        plt.xlabel('Predicted label')
        plt.show()
        plt.savefig(f'confusion_matrix_skip_{str(window_size)}.png')
        ...
        torch.save(model, f'./models/skip-gram-classification-model_{str(window_size)}.pt')
        print(f"Model saved as ./models/skip-gram-classification-model_{str(window_size)}.pt")